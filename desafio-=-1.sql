...
CREATE TABLE purchases (
  ...
  PRIMARY KEY (users_id, travel_package_id),
  INDEX fk_users_has_travel_packages_travel_packages1_idx (travel_package_id ASC) VISIBLE,
  INDEX fk_users_has_travel_packages_users_idx (users_id ASC) VISIBLE,
  CONSTRAINT fk_users_has_travel_packages_users
    FOREIGN KEY (users_id)
    REFERENCES users (id),
  CONSTRAINT fk_users_has_travel_packages_travel_packages1
...
CREATE TABLE travel_packages_locations (
  ...
  PRIMARY KEY (travel_packages_id, location_id),
...
INSERT INTO travel_packages (package_name, departure_date, return_date, package_price) 
VALUES
